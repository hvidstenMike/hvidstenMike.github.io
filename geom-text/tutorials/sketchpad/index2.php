    ...
    <div id="wrapper">
		...
		<div id = "software-projects-main">
				<header class = "software-projects-header">
					Using Geometer's Sketchpad for Exploring Geometry
				</header>
				<div class = "tutorial-comments">
					<p>
						...
						needed for that project are covered in the <b>Sketchpad Tools</b>
						tutorials. As you progress through the projects, your mastery of
						Sketchpad will increase. Later tutorials will be much
				...
				<div  id = "software-projects-menu-div">
				  <ul>
					<li class="software-projects-menu-item"><a href = "./intro-desktop.php"> 
						Using Geometer's Sketchpad as a Desktop App
					</a></li>
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> Sketchpad Tools:</span> 
						<select  name="page-links" onchange="location = this.value;">
							<option value="">Select a Topic:</option>
							<option value="./toolbar.php">Sketchpad Tool Bar</option>
					...
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> Sketchpad Help for Projects</span> 
						<select  name="page-links" onchange="location = this.value;">
