		...
		<div id = "software-tutorial-main">
				...
				<div  id = "tutorial-content">
					...
					<div class = "tutorial-row">
						...
						and the product of  PQ<sub>1</sub> with  PQ<sub>2</sub>. We will use Sketchpad's 
							Calculator to find these products. Choose <b>Calculate...</b> from the 
							<b>Number</b> menu. Then, click on the PP<sub>1</sub> measure in the 
							main window to bring it into the Calculator. Then, click the multiply button ('*') 
							and then select the PP<sub>2</sub> measure. Finally, click 'Okay'
