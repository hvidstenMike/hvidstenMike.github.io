    ...
    <div id="wrapper">
		...
		<div id = "software-projects-main">
				<header class = "software-projects-header">
					Using Cinderella for Exploring Geometry
				</header>
				<div class = "tutorial-comments">
					<p>
						...
						needed for that project are covered in the <b>Cinderella Tools</b>
						tutorials. As you progress through the projects, your mastery of
						Cinderella will increase. Later tutorials will be much
				...
				<div  id = "software-projects-menu-div">
				  <ul>
					...
					<li class="software-projects-menu-item"><a href = "./intro-desktop.php"> 
						Using Cinderella as a Desktop App
					</a></li>
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> Cinderella Tools:</span> 
					...
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> Cinderella Help for Projects</span> 
						<select  name="page-links" onchange="location = this.value;">
