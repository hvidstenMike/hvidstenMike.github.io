    ...
    <div id="wrapper">
		...
		<div id = "software-projects-main">
				<header class = "software-projects-header">
					Using Geogebra for Exploring Geometry
				</header>
				<div class = "tutorial-comments">
					<p>
						...
						needed for that project are covered in the <b>GeoGebra Tools</b>
						tutorials. As you progress through the projects, your mastery of
						GeoGebra will increase. Later tutorials will be much
						more concise than earlier tutorials.
					</p>
				</div>
				<div  id = "software-projects-menu-div">
				  <ul>
					<li class="software-projects-menu-item"><a href = "./intro-webapp.php"> 
						Using Geogebra as a Web App
					</a></li>
					<li class="software-projects-menu-item"><a href = "./intro-desktop.php"> 
						Using Geogebra as a Desktop App
					</a></li>
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> Geogebra Tools:</span> 
						<select  name="page-links" onchange="location = this.value;">
							<option value="">Select a Topic:</option>
							<option value="./toolbar.php">GeoGebra Tool Bar</option>
					...
					<li class="software-projects-menu-item">
						<span class="software-projects-menu-item-text"> GeoGebra Help for Projects</span> 
						<select  name="page-links" onchange="location = this.value;">
