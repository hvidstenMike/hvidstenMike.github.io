		...
		<div id = "software-tutorial-main">
				...
				<div  id = "tutorial-content">
					<div class = "tutorial-row">
						...
						B to C. Attach a point A' to segment AB. Compute the ratio
							of the length of A'A to AB by selecting points A', A, and B
					...
					<div class = "tutorial-row">
						...
						The next step is to use this ratio as a dilation factor to dilate point
							C to B by this ratio.  We first select point B and choose 
							<b>Center</b>  from the <b>Mark</b>menu in the Transform panel to
							set B as the center of dilation. 
						</p>
						</div>
						<div class="tutorial-right">
					...
					<div class = "tutorial-row">
						...
						choose <b>Ratio</b> under the <b>Mark</b> menu. 
						</p>
						</div>
						<div class="tutorial-right">
					...
					<div class = "tutorial-row">
						<div class="tutorial-left">
						<p> Now, select point C and click the Dilate button
						<img src="./images/dilate.png"  style="width:30px" alt ="Dilate Tool">
					...
					<div class = "tutorial-row">
						...
						To do this, select point c(t) 
							Then, choose <b>Trace On</b> under the <b>View</b> menu. 
